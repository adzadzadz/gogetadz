...
use app\models\UserNetworkSearch;
...
/**
 * UserNetworkController implements the CRUD actions for UserNetwork model.
 */
class UserNetworkController extends Controller
{
    ...
    {
        $searchModel = new UserNetworkSearch();
    ...
    {
        if (($model = UserNetwork::findOne(['user_id' => $id])) !== null) {
            return $model;
        }
